...
namespace WarGames_Defcon_1.Code.Scripts.Input {
    public partial class Input : IInputActionCollection2, IDisposable {
        ...
        public Input() {
            ...
            m_Player_FireMain = m_Player.FindAction("Fire Main", throwIfNotFound: true);
            m_Player_FireAlternate = m_Player.FindAction("Fire Alternate", throwIfNotFound: true);
        ...
        private readonly InputAction m_Player_FireMain;
        private readonly InputAction m_Player_FireAlternate;
        ...
        public struct PlayerActions {
            ...
            public InputAction @FireMain => m_Wrapper.m_Player_FireMain;
            public InputAction @FireAlternate => m_Wrapper.m_Player_FireAlternate;
            ...
            public void SetCallbacks(IPlayerActions instance) {
                if (m_Wrapper.m_PlayerActionsCallbackInterface != null) {
                    ...
                    @FireMain.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnFireMain;
                    @FireMain.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnFireMain;
                    @FireMain.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnFireMain;
                    @FireAlternate.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnFireAlternate;
                    @FireAlternate.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnFireAlternate;
                    @FireAlternate.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnFireAlternate;
                ...
                @FireAlternate.started += instance.OnFireAlternate;
                @FireAlternate.performed += instance.OnFireAlternate;
                @FireAlternate.canceled += instance.OnFireAlternate;
        ...
        public interface IPlayerActions {
            ...
            void OnFireAlternate(InputAction.CallbackContext context);
